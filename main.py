...
try: app_id = int(os.environ.get("app_id", "25169055"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "d70362ef232cc5ec4cb0b8d1ba6cc60e")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6950853952:AAGNepz-sMDCe87ooajpqMq4AQzzwtqcMD4")
